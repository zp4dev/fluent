...
const vi = {
  ...
  practice: {
    intro:
      "Luyện lại chính những câu và từ đã có trong bài — không tốn lượt tạo bài mới.",
    pickFormat: "Chọn dạng bài tập",
    backToFormats: "← Chọn dạng khác",
    progress: "Câu {current} / {total}",
    check: "Kiểm tra",
    next: "Tiếp tục",
    finish: "Xem kết quả",
    ...
    answerWas: "Đáp án đúng: {answer}",
    score: "Bạn làm đúng {score}/{total}!",
    scorePerfect: "Tuyệt đối — quá giỏi!",
    scoreGood: "Khá lắm — luyện thêm chút nữa nhé!",
    scorePoor: "Xem lại phần từ vựng rồi thử lại nhé!",
    clue: "Nghĩa tiếng Việt",
    showClue: "Xem nghĩa",
    kindFillBlank: "Điền chỗ trống",
    kindFillBlankHint: "Điền cụm từ còn thiếu vào câu.",
    kindMatching: "Nối từ",
    kindMatchingHint: "Nối từ tiếng Anh với nghĩa của nó.",
    kindDictation: "Nghe – viết",
    kindDictationHint: "Nghe câu rồi gõ lại chính xác.",
    kindWordOrder: "Sắp xếp câu",
    kindWordOrderHint: "Sắp xếp các từ thành câu hoàn chỉnh.",
    fillPlaceholder: "Điền vào chỗ trống…",
    fillHint: "Gợi ý",
    fillHintUsed: "Bắt đầu bằng “{hint}” ({count} chữ cái)",
    dictationPlay: "Nghe câu",
    dictationSlow: "Nghe chậm",
    dictationPlaceholder: "Gõ lại câu bạn nghe được…",
    dictationUnsupported:
      "Trình duyệt này không đọc được tiếng Anh. Bạn vẫn có thể bấm “Xem nghĩa” rồi tự viết lại câu.",
    dictationReveal: "Câu đúng:",
    orderIntro: "Chạm vào các từ theo đúng thứ tự.",
    orderClear: "Xóa hết",
    orderUndo: "Bỏ từ cuối",
    orderEmpty: "Chạm vào từ bên dưới để bắt đầu.",
    matchingIntro: "Chạm một từ tiếng Anh, rồi chạm nghĩa tương ứng.",
    matchingRound: "Vòng {current} / {total}",
    matchingRemaining: "Còn {count} cặp",
    matchingMistakes: "Số lần nối sai: {count}",
    matchingDone: "Xong vòng này! 🎉",
    emptyTitle: "Bài học này chưa đủ dữ liệu để luyện tập",
    emptyBody:
      "Hãy thử một video khác có nhiều câu ví dụ và từ vựng hơn nhé.",
  },
