...
const en: Dictionary = {
  ...
  practice: {
    intro:
      "Drill the exact sentences and words this lesson already has — no new lesson needed.",
    pickFormat: "Pick an exercise",
    backToFormats: "← Pick another exercise",
    progress: "Question {current} of {total}",
    check: "Check",
    next: "Continue",
    finish: "See results",
    ...
    score: "You got {score}/{total} right!",
    scorePerfect: "Flawless — brilliant work!",
    scoreGood: "Nice — a little more practice and you're there!",
    scorePoor: "Review the vocabulary and give it another go!",
    clue: "Meaning",
    showClue: "Show meaning",
    kindFillBlank: "Fill the gap",
    kindFillBlankHint: "Type the missing phrase into the sentence.",
    kindMatching: "Match up",
    kindMatchingHint: "Match each English word to its meaning.",
    kindDictation: "Dictation",
    kindDictationHint: "Listen to the sentence and type it back.",
    kindWordOrder: "Sentence order",
    kindWordOrderHint: "Put the words back into the right order.",
    fillPlaceholder: "Fill in the gap…",
    fillHint: "Hint",
    fillHintUsed: "Starts with “{hint}” ({count} letters)",
    dictationPlay: "Play",
    dictationSlow: "Play slowly",
    dictationPlaceholder: "Type what you hear…",
    dictationUnsupported:
      "This browser can't read English aloud. You can still tap “Show meaning” and write the sentence from that.",
    dictationReveal: "The sentence was:",
    orderIntro: "Tap the words in the right order.",
    orderClear: "Clear",
    orderUndo: "Undo last word",
    orderEmpty: "Tap a word below to start.",
    matchingIntro: "Tap an English word, then tap its meaning.",
    matchingRound: "Round {current} of {total}",
    matchingRemaining: "{count} pairs left",
    matchingMistakes: "Wrong matches: {count}",
    matchingDone: "Round complete! 🎉",
    emptyTitle: "This lesson doesn't have enough material to practise",
    emptyBody: "Try another video with more example sentences and vocabulary.",
  },
