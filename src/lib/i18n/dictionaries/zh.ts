...
const zh: Dictionary = {
  ...
  practice: {
    intro: "只用本课已有的句子和单词反复练习——不会消耗新的生成次数。",
    pickFormat: "选择练习类型",
    backToFormats: "← 换一种练习",
    ...
    correct: "答对了！🎉",
    incorrect: "还不对。",
    answerWas: "正确答案：{answer}",
    score: "你答对了 {score}/{total} 题！",
    scorePerfect: "全对——太棒了！",
    scoreGood: "不错——再练一点就完美了！",
    scorePoor: "复习一下生词再来一次吧！",
    clue: "中文意思",
    showClue: "显示意思",
    kindFillBlank: "填空",
    kindFillBlankHint: "把句子里缺少的词组填进去。",
    kindMatching: "连线配对",
    kindMatchingHint: "把英文单词和它的意思配对。",
    kindDictation: "听写",
    kindDictationHint: "听句子，然后原样打出来。",
    kindWordOrder: "句子排序",
    kindWordOrderHint: "把打乱的词重新排成句子。",
    fillPlaceholder: "在这里填空……",
    fillHint: "提示",
    fillHintUsed: "以“{hint}”开头（共 {count} 个字母）",
    dictationPlay: "播放",
    dictationSlow: "慢速播放",
    dictationPlaceholder: "打出你听到的句子……",
    dictationUnsupported:
      "此浏览器无法朗读英文。你仍可以点“显示意思”，再照着写出句子。",
    dictationReveal: "原句是：",
    orderIntro: "按正确顺序点击下面的词。",
    orderClear: "清空",
    orderUndo: "撤回最后一个词",
    orderEmpty: "点击下面的词开始。",
    matchingIntro: "先点一个英文单词，再点它的意思。",
    matchingRound: "第 {current} / {total} 轮",
    matchingRemaining: "还剩 {count} 组",
    matchingMistakes: "配对错误次数：{count}",
    matchingDone: "本轮完成！🎉",
    emptyTitle: "这节课的内容还不够做练习",
    emptyBody: "换一个例句和生词更多的视频试试吧。",
  },
  ...
  auth: {
    ...
    signIn: "登录",
    signInTitle: "登录 Fluent",
    signInBody: "填写邮箱，我们会发送一个 6 位数验证码，无需密码。",
    sendCode: "发送验证码",
    sending: "发送中...",
    verify: "验证",
    verifying: "验证中...",
